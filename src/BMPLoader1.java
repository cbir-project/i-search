//CLASS DESIGNED TO LOAD A BMP IMAGE FILE
// BMPLoader.java
...

{
...

  {
         ...
         try {
            ...
            BitmapHeader1 bh = new BitmapHeader1();
  ...
  protected static Image readMap32(FileInputStream fs,BitmapHeader1 bh) throws IOException
  ...
  protected static Image readMap24(FileInputStream fs,BitmapHeader1 bh) throws IOException

  {
    ...
    */
    ...
    protected static Image readMap8(FileInputStream fs,BitmapHeader1 bh) throws IOException
...
BMPLoader1(String a) throws FileNotFoundException
	{
		String s=a;
